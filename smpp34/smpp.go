...
const (
	...
	SmppBindReqErr  SmppErr = "BIND req not received in 10 second"
...
func (s *Smpp) AcceptedConnect(c net.Conn) {
	s.conn = c
}
...
func (s *Smpp) SubmitSmEncodedEx(source_addr, destination_addr string, short_message []byte, params *Params, setTLV func(Pdu)) (Pdu, error) {

	p, err := s.SubmitSmEncoded(source_addr, destination_addr, short_message, params)
...
func (s *Smpp) DeliverySmEncoded(source_addr, destination_addr string, short_message []byte, params *Params) (Pdu, error) {
...
func (s *Smpp) DeliverSmEncodedEx(source_addr, destination_addr string, short_message []byte, params *Params, setTLV func(Pdu)) (Pdu, error) {

	p, err := s.DeliverSmEncoded(source_addr, destination_addr, short_message, params)
...
func (s *Smpp) DeliverSmEncoded(source_addr, destination_addr string, short_message []byte, params *Params) (Pdu, error) {
